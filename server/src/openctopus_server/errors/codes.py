...
class ErrorCode(StrEnum):
    ...
    TOOL_CHANNEL_RETRY_REQUIRES_NEW_TURN = "tool_channel_retry_requires_new_turn"
    TOOL_CHANNEL_MEDIA_SIZE_UNKNOWN = "tool_channel_media_size_unknown"
    ...
    CHANNEL_CREDENTIALS_UNVERIFIED = "channel_credentials_unverified"
    CHANNEL_BOT_ALREADY_BOUND = "channel_bot_already_bound"
    CHANNEL_PAIRING_UNAVAILABLE = "channel_pairing_unavailable"
    # Chat/provider
    NOT_FOUND = "not_found"
    INVALID_MESSAGE_CONTENT = "invalid_message_content"
    INVALID_CURSOR = "invalid_cursor"
    INVALID_REQUEST = "invalid_request"
    SESSION_INVALID_REQUEST = "session_invalid_request"
    CRON_INVALID_SCHEDULE = "cron_invalid_schedule"
