...
ERROR_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.CHANNEL_NOT_SUPPORTED: 400,
    ErrorCode.CHANNEL_CONFIG_NOT_FOUND: 404,
    ErrorCode.CHANNEL_CREDENTIALS_INVALID: 400,
    ErrorCode.CHANNEL_CREDENTIALS_UNVERIFIED: 503,
    ErrorCode.CHANNEL_BOT_ALREADY_BOUND: 409,
    ErrorCode.CHANNEL_PAIRING_UNAVAILABLE: 409,
