...
export type MessageAttachmentRef = components['schemas']['MessageAttachmentRef']
...
export type CronSchedule = components['schemas']['CronJobSummary']['schedule']
export type CronJobSummary = components['schemas']['CronJobSummary']
export type CronJob = components['schemas']['CronJobResponse']
export type CronJobPage = components['schemas']['CronJobsResponse']
